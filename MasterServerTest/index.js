...
mongoose
	...
	.then(() => {
		...
		// Handle process termination to clear the mongoose tables
		...
		async function cleanup() {
			try {
				console.log('Cleaning up mongoose tables before termination...');
				await Server.deleteMany({});
				await Token.deleteMany({});
				console.log('Mongoose tables cleared. Closing server...');
